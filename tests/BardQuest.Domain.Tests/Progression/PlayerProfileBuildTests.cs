...
public class PlayerProfileBuildTests
{
    ...
    {
        var profile = PlayerProfile.FromCompletedSongs([], QuestPace.Journey);
    ...
    public void CompletingSongsGrantsXpAndLevels()
    {
        ...
        var profile = PlayerProfile.FromCompletedSongs(plays, QuestPace.Journey);
    ...
    public void OutleveledRerunsAddNothing()
    {
        ...
        var before = PlayerProfile.FromCompletedSongs(climb, QuestPace.Journey);

        var withRerun = new List<(AttributeProfile, PerformanceFacts)>(climb) { Play(strength: 2, technique: 0) };
        var after = PlayerProfile.FromCompletedSongs(withRerun, QuestPace.Journey);
    ...
    public void BuildIsDeterministic()
    {
        ...
        var a = PlayerProfile.FromCompletedSongs(plays, QuestPace.Journey);
        var b = PlayerProfile.FromCompletedSongs(plays, QuestPace.Journey);
